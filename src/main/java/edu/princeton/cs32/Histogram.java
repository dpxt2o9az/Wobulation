...
public class Histogram {
    ...
    public static void main(String[] args) {
        ...
        int n = args.length >= 1 ? Integer.parseInt(args[0]) : 12;       // number of coins
        int trials = args.length >= 2 ? Integer.parseInt(args[1]) : 1000;  // number of trials
